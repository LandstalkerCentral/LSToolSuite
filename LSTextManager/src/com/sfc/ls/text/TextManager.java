 ...
 */
package com.sfc.ls.text;

import com.sfc.ls.text.io.AsmManager;
import com.sfc.ls.text.io.CustomManager;
import com.sfc.ls.text.io.TxtManager;
import com.sfc.ls.text.io.DisassemblyManager;
import com.sfc.ls.text.io.RomManager;
...
public class TextManager {
    ...
    public static void importDisassembly(String basePath){
        System.out.println("com.sfc.ls.text.TextManager.importDisassembly() - Importing disassembly ...");
        TextManager.gamescript = DisassemblyManager.importDisassembly(basePath);
        System.out.println("com.sfc.ls.text.TextManager.importDisassembly() - Disassembly imported.");
    }
    
    public static void exportDisassembly(String basePath){
        System.out.println("com.sfc.ls.text.TextManager.importDisassembly() - Exporting disassembly ...");
        DisassemblyManager.exportDisassembly(gamescript, basePath);
        System.out.println("com.sfc.ls.text.TextManager.importDisassembly() - Disassembly exported.");        
    }   
    
    public static void importOriginalRom(String originalRomFilePath){
        System.out.println("com.sfc.ls.text.TextManager.importOriginalRom() - Importing original ROM ...");
        TextManager.gamescript = RomManager.importRom(RomManager.ORIGINAL_ROM_TYPE,originalRomFilePath);
        System.out.println("com.sfc.ls.text.TextManager.importOriginalRom() - Original ROM imported.");
    }
    
    public static void exportOriginalRom(String originalRomFilePath){
        System.out.println("com.sfc.ls.text.TextManager.exportOriginalRom() - Exporting original ROM ...");
        RomManager.exportRom(RomManager.ORIGINAL_ROM_TYPE, TextManager.gamescript, originalRomFilePath);
        System.out.println("com.sfc.ls.text.TextManager.exportOriginalRom() - Original ROM exported.");        
    }   
    
    public static void importCaravanRom(String caravanRomFilePath){
        System.out.println("com.sfc.ls.text.TextManager.importCaravanRom() - Importing Caravan ROM ...");
        TextManager.gamescript = RomManager.importRom(RomManager.CARAVAN_ROM_TYPE,caravanRomFilePath);
        System.out.println("com.sfc.ls.text.TextManager.importCaravanRom() - Caravan ROM imported.");
    }
    
    public static void exportCaravanRom(String caravanRomFilePath){
        System.out.println("com.sfc.ls.text.TextManager.exportCaravanRom() - Exporting Caravan ROM ...");
        RomManager.exportRom(RomManager.CARAVAN_ROM_TYPE, TextManager.gamescript, caravanRomFilePath);
        System.out.println("com.sfc.ls.text.TextManager.exportCaravanRom() - Caravan ROM exported.");        
    } 
    ...
    public static void importCustomRom(String customRomFilePath, int huffmanTreeOffsetsBegin, int huffmanTreeOffsetsEnd, int huffmanTreesOffsetsBegin, int huffmanTreesOffsetsEnd, int textbanksOffsetsPointerOffset, int lastLineIndex){
        System.out.println("com.sfc.ls.text.TextManager.importCustomRom() - Importing Custom ROM ...");
        ...
        System.out.println("com.sfc.ls.text.TextManager.importCustomRom() - Custom ROM imported.");
    }
    ...
    public static void exportCustomRom(String customRomFilePath, int huffmanTreeOffsetsOffset, int huffmanTreesOffset, int textbanksPointerOffset, int textbanksOffset){
        System.out.println("com.sfc.ls.text.TextManager.exportCustomRom() - Exporting Custom ROM ...");
        ...
        System.out.println("com.sfc.ls.text.TextManager.exportCustomRom() - Custom ROM exported.");        
    }     
    
    public static void importTxt(String filepath){
        System.out.println("com.sfc.ls.text.TextManager.importTxt() - Importing TXT ...");
        gamescript = TxtManager.importTxt(filepath);
        System.out.println("com.sfc.ls.text.TextManager.importTxt() - TXT imported.");
    }
    
    public static void exportTxt(String filepath){
        System.out.println("com.sfc.ls.text.TextManager.exportTxt() - Exporting TXT ...");
        TxtManager.exportTxt(gamescript, filepath);
        System.out.println("com.sfc.ls.text.TextManager.exportTxt() - TXT exported.");       
    }
